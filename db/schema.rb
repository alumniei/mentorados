...
ActiveRecord::Schema.define(version: 2021_09_10_231915) do
  ...
  create_table "password_recoveries", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["selector"], name: "index_password_recoveries_on_selector"
  end
